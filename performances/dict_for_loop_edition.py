...
timeit("update_dict(my_dict)", setup="from __main__ import update_dict, my_dict", number=100)
# 0.08109318400011034

timeit("unpack_dict(my_dict)", setup="from __main__ import unpack_dict, my_dict", number=100)
# 2.406963264000069

timeit("unpack_dict_inline(my_dict)", setup="from __main__ import unpack_dict_inline, my_dict", number=100)
# 0.025858885000161536

timeit("unpack_new_dict_inline(my_dict)", setup="from __main__ import unpack_new_dict_inline, my_dict", number=100)
